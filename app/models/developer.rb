class Developer < ApplicationRecord
  ...
  validates_inclusion_of :language1, :language2, :language3, :language4, :in => %w( Ruby Rails HTML CSS JS JQuery SQL Node React Angular PHP Python ), :on => :create, :message => "That language %s is not included in the list"
